# -*- coding: utf-8 -*-
"""
Created on Mon Jul  3 15:49:23 2023
...
# Prompt for the source folder path
subfolder_path = input("Enter the path of the folder containing the spreadsheets: ")

# Prompt for the destination path and name
destination_path = input("Enter the destination path and name for the consolidated workbook: ")
...
consolidated_workbook.save(destination_path)
