# -*- coding: utf-8 -*-
"""
Created on Wed Jul  5 13:37:56 2023
...
destination_file = r'C:\Users\zeh\Desktop\Laborergebnissse\01.LaborergebnisseFinal.xlsx'
info_file = r'C:\Users\zeh\Desktop\Laborergebnissse\Skript\TransferbackNEW_info.txt'
...
# Save the last transferred spreadsheet and column information to a text file
with open(info_file, 'w') as file:
    file.write(f"Last transferred spreadsheet: {last_copied_sheet}\n")
    file.write(f"Last transferred column: {last_copied_column}")
